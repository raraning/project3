...
public class HotelController {
	...
	// servlet-context.xmlÏóê ÏûàÎäî bean id="uploadPath" Í≤ΩÎ°ú Îß§Ïπ≠
...
public class HotelController {
	...
	// √∑∫Œ∆ƒ¿œ ¿˙¿Â ∞Ê∑Œ
	// servlet-context.xmlø° ¿÷¥¬ bean id="uploadPath" ∞Ê∑Œ ∏≈ƒ™
	@Resource(name="uploadPath")
	private String uploadPath;
